...
from minipacman.deepmind import PillEater, observation_as_rgb
...
class MiniPacman:
    ...
    def get_ghost_pos(self):
        return self.env.get_ghost_pos()

    def get_pac_pos(self):
        return self.env.get_pac_pos()

    def check_ghosts(self):
        return self.env.check_ghosts()