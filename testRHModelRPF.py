...
#from a2c import A2C
from models.env_model_rpf import EnvModel
...
for step in range(p.STEPS):
    ...
    if p.ERROR_CORRECTION:
        for e in range(p.N_EVALS):
            ...
            iim.save(join('samples-trajec/trajEpi'+str(episode)+
    ...
    #trajecImg += agentRH.trajecImg
    #trajecECImg += agentRH.trajecECImg
